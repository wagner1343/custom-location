...
public class LocationPlugin implements MethodCallHandler, StreamHandler, PluginRegistry.ActivityResultListener {
    ...
    private boolean checkPermissions() {
        ...
        boolean hasPermission = this.locationPermissionState == PackageManager.PERMISSION_GRANTED;
    ...
    public boolean doCheckServiceEnabled() {
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    switch (statusCode) {
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            ...
                            break;
                        case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                            errorCode = "SETTINGS_CHANGE_UNAVAILABLE";
                            break;
                        default:
                            errorCode = "UNKNOWN_ERROR";
                    }

                    result.error(errorCode, ex.getMessage(), null);
                }
            });
        }
        catch (Exception e){
