...
class Location {
  ...
  Future<LocationData> getLocation() async {
    print("location.dart getLocation");
    try {
      print("var result = await _channel.invokeMethod('getLocation');");
      var result = await _channel.invokeMethod('getLocation');
      print(result);
      print("var locationData = LocationData.fromMap(result.cast<String, double>())");
      var locationData = LocationData.fromMap(result.cast<String, double>());
      return locationData;
    }
    catch(e, s) {
      print(e);
